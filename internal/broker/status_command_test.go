...
func TestStatusForTopic_LiveHolderReadsAttached(t *testing.T) {
	...
	if !strings.Contains(got, "· Claude Code attached · build unknown · Live route: channel. · broker up") {
...
func TestStatusForTopic_NamesTheSurface(t *testing.T) {
	...
	got := b.statusForTopic("telegram", -1001234567890, &tid)
	if !strings.Contains(got, "· Claude Desktop attached · build unknown · Live route: channel. · broker up") {
