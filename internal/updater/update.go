...
// checksum BEFORE touching anything, validates all eleven shipped binaries plus
// the STT bundle, then replaces the ten core binaries in place. The optional cmd/codex launcher is
