...
// method names. Used for `notifications/message` log frames (system
// advisories, broker-down notices) — the SDK's typed Log API enforces level
// filtering and would rather not be drilled through for the unfiltered
// shape we want; the cleanest path is to write the raw notification
// ourselves via the underlying Connection.
//
