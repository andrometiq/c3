...
BINS="c3-broker c3-claude-adapter c3-codex-adapter c3-grok-adapter c3-agy-adapter c3-cursor-adapter c3-desktop-adapter codex claude-shim migrate-legacy"
